...
namespace MyNN.MLP.DropConnect.ForwardPropagation.TrainItemForward.OpenCL.GPU2
{
    public class LayerPropagator : ILayerPropagator
    {
        private readonly CLProvider _clProvider;
        private readonly IOpenCLWeightMaskContainer2 _maskContainer;
        ...
        public LayerPropagator(
            ...
            KernelSource ks,
            IOpenCLWeightMaskContainer2 maskContainer,
