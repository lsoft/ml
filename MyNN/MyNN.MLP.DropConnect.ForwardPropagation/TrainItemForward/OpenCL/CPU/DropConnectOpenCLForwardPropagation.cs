...
namespace MyNN.MLP.DropConnect.ForwardPropagation.TrainItemForward.OpenCL.CPU
{
    /// <summary>
    /// Stochastic dropconnect forward propagation algorithm for CPU-OpenCL.
    /// It consumes bit weights containers.
    /// </summary>
        ...
        public void Propagate(DataItem d)
        {
            ...
            for (var layerIndex = 1; layerIndex < layerCount; layerIndex++)
            {
                ...
                _kernels[layerIndex]
                    ...
                    .SetKernelArg(8, 4, this._weightMaskContainer.BitMask)
