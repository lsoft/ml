...
namespace MyNN.MLP2.ForwardPropagation.DropConnect.TrainItemForward.Float.OpenCL.CPU
{
    /// <summary>
    /// Stochastic dropconnect forward propagation algorithm for CPU-OpenCL.
    /// It consumes float weights containers.
    /// </summary>
    public class DropConnectOpenCLForwardPropagation : IForwardPropagation
    {
        ...
        private readonly IOpenCLWeightMaskContainer _weightMaskContainer;
        ...
        /// <param name="weightMaskContainer">Stochastic Bernoulli weight mask container with float mask</param>
        public DropConnectOpenCLForwardPropagation(
            VectorizationSizeEnum vse,
            IMLP mlp,
            CLProvider clProvider,
            IOpenCLWeightMaskContainer weightMaskContainer
            )
        {
            if (mlp == null)
            {
            ...
            if (weightMaskContainer == null)
            {
                throw new ArgumentNullException("weightMaskContainer");
            }

            _vse = vse;
            _mlp = mlp;
            _clProvider = clProvider;
            _weightMaskContainer = weightMaskContainer;
            ...
            int previousLayerNeuronCountTotal)
{
    ...
    {
        lastNET += mask[weightIndex] * weights[weightIndex] * previousLayerLastState[plnIndex];
        weightIndex++;
    }
            ...
            int previousLayerNeuronCountTotal)
{
        ...
        ++plnIndex4, ++weightIndex4)
    {
        ...
        float4 mask4 = vload4(weightIndex4, mask + weightShift4);
            ...
            int previousLayerNeuronCountTotal)
{
        ...
        ++plnIndex16, ++weightIndex16)
    {
        ...
        float16 mask16 = vload16(weightIndex16, mask + weightShift16);
        ...
        public void Propagate(DataItem d)
        {
            ...
            for (var layerIndex = 1; layerIndex < layerCount; layerIndex++)
            {
                ...
                _kernels[layerIndex]
                    ...
                    .SetKernelArgMem(4, this._weightMaskContainer.MaskMem[layerIndex])
