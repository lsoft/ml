...
namespace MyNN.MLP2.Backpropagation.EpocheTrainer.TransposedClassic2.OpenCL.GPU
{
    ...
    /// </summary>
    public class GPUTranspose2BackpropagationEpocheTrainer : IBackpropagationEpocheTrainer
    {
        ...
        public GPUTranspose2BackpropagationEpocheTrainer(
            IMLP mlp,
        ...
        private void LoadPrograms()
        {
            ...
            _updateWeightKernel = _clProvider.CreateKernel(
                KernelConstructor.GetUpdateWeightKernelSource(BLOCK_DIM),
            ...
            float learningRate)
        {
            ...
            for (var layerIndex = 1; layerIndex < _mlp.Layers.Length; ++layerIndex)
            {
                ...
                var glob = new int[]
                    {
                        ShrRoundUp(BLOCK_DIM, _mlp.Layers[layerIndex].NonBiasNeuronCount),
                        ShrRoundUp(BLOCK_DIM, _mlp.Layers[layerIndex - 1].Neurons.Length)
                    };
                ...
                _updateWeightKernel
                    ...
                    .SetKernelArgLocalMem(3, (BLOCK_DIM + 1) * BLOCK_DIM * 4)
                    .SetKernelArg(4, 4, _mlp.Layers[layerIndex].NonBiasNeuronCount)
                    .SetKernelArg(5, 4, _mlp.Layers[layerIndex - 1].Neurons.Length)
                    .SetKernelArg(6, 4, (float)(_config.BatchSize))
