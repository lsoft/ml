...
{
    public class CPUMaskForwardPropagatorComponentConstructor : CPUPropagatorComponentConstructor
    {
        public CPUMaskForwardPropagatorComponentConstructor(
            IRandomizer randomizer,
            CLProvider clProvider,
            VectorizationSizeEnum vse,
            IOpenCLMaskContainerFactory maskContainerFactory,
            float p
            ) : base(randomizer, clProvider, vse, maskContainerFactory, p)
        {
        }
