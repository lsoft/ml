...
using MyNN.MLP.Classic.Backpropagation.EpocheTrainer.Classic.OpenCL.CPU.KernelText;
...
namespace MyNN.MLP.Classic.Backpropagation.EpocheTrainer.Classic.OpenCL.CPU
{
    /// <summary>
    /// Classic backpropagation epoche trainer that enables CPU-OpenCL
    /// </summary>
    public class CPUEpocheTrainer : IEpocheTrainer
    {
