...
using MyNN.MLP.Classic.Backpropagation.EpocheTrainer.Classic.OpenCL.GPU2.KernelText;
...
namespace MyNN.MLP.Classic.Backpropagation.EpocheTrainer.Classic.OpenCL.GPU2
{
    /// <summary>
    /// Classic backpropagation epoche trainer that enables GPU-OpenCL
    /// </summary>
    public class GPU2EpocheTrainer : IEpocheTrainer
    {
...

                                {
                                    ...
                                    if (inBatchIndex == 0)
                                    {
                                        _hiddenKernelOverwrite[hiddenLayerIndex]
                                            ...
                                            .SetKernelArgMem(15, _preprocessCache[hiddenLayerIndex])
                                            .EnqueueNDRangeKernel(
                                                new[]
                                                {
                                                    HiddenGlobalGroupSize
