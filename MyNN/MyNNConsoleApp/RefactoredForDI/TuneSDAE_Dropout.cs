                ...
                Func<int, INoiser> noiserProvider =
                    (int epocheNumber) =>
                    {
                        ...
                        var noiser = new SequenceNoiser(
                            randomizer,
                            true,
                            new GaussNoiser(coef * 0.10f, false, new RandomSeriesRange(randomizer, trainData[0].InputLength)),
                            new MultiplierNoiser(randomizer, coef * 0.7f, new RandomSeriesRange(randomizer, trainData[0].InputLength)),
                            new DistanceChangeNoiser(randomizer, coef * 0.7f, 3, new RandomSeriesRange(randomizer, trainData[0].InputLength)),
