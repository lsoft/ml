    ...
    public class NVidiaComputeLayerFixture
    {
        ...
        public void Test_1_1()
        {
            ...
            using (var clProvider = new CLProvider(new NvidiaOrAmdGPUDeviceChooser(false), false))
            {
                ...
                MyNN.MLP2.ForwardPropagation.Classic.OpenCL.GPU.LayerPropagator lp;
                ConstuctComponents(
                    clProvider,
                    nf,
        ...
        private static void ConstuctComponents(
            ...
            out MyNN.MLP2.ForwardPropagation.Classic.OpenCL.GPU.LayerPropagator lp)
        {
            if (clProvider == null)
            {
            ...
            lp = new MyNN.MLP2.ForwardPropagation.Classic.OpenCL.GPU.LayerPropagator(
                clProvider,
                ks,
                plc,
                clc,
