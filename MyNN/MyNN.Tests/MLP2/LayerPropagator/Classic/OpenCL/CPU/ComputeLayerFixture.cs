...
namespace MyNN.Tests.MLP2.LayerPropagator.Classic.OpenCL.CPU
{
    [TestClass]
    public class ComputeLayerFixture
    {
        ...
        public void Test_1_1_NoVec()
        {
            ...
            const VectorizationSizeEnum vse = VectorizationSizeEnum.NoVectorization;
        ...
        public void Test0_40_1_Vec4()
        {
            ...
            const int previousLayerNeuronCount = 40;
            const int currentLayerNeuronCount = 1;
            const VectorizationSizeEnum vse = VectorizationSizeEnum.VectorizationMode4;
        ...
        public void Test0_40_1_Vec16()
        {
            ...
            const int previousLayerNeuronCount = 40;
            const int currentLayerNeuronCount = 1;
            const VectorizationSizeEnum vse = VectorizationSizeEnum.VectorizationMode16;
