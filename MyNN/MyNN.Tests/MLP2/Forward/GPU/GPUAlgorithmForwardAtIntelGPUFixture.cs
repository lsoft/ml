...
{
    /// <summary>
    /// Summary description for GPUAlgorithmForwardAtIntelGPUFixture
    /// </summary>
    [TestClass]
    public class GPUAlgorithmForwardAtIntelGPUFixture
    {
        private const float ForwardEpsilon = 1e-6f;

        public GPUAlgorithmForwardAtIntelGPUFixture()
        {
            //
