...
{
    /// <summary>
    /// Summary description for GPUForward2Fixture
    /// </summary>
    [TestClass]
    public class GPUForward2Fixture
    {
        private const float ForwardEpsilon = 1e-6f;

        public GPUForward2Fixture()
        {
            //
        ...
        [TestMethod]
        public void GPUForward_5_24_24_1_Test()
        {
            var test = new ForwardTester();
        ...
        [TestMethod]
        public void GPUForward_5_300_1_Test()
        {
            var test = new ForwardTester();
