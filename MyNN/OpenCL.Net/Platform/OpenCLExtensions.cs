...
namespace OpenCL.Net.Platform
{
    ...
    public static class OpenCLExtensions
    {
        ...
        public static Cl.Kernel SetKernelArgLocalMem(this Cl.Kernel kernel, uint argId, int size)
        {
            Cl.ErrorCode error = Cl.SetKernelArg(kernel, argId, size, null);
        ...
        /// </summary>
        public static void EnqueueNDRangeKernel(this Cl.Kernel kernel, Cl.CommandQueue commandQueue, int[] globalSizes, int[] localSizes)
        {
            Cl.Event clevent;
