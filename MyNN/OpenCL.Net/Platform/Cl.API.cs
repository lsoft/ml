...
namespace OpenCL.Net.Platform
{
    ...
    public static partial class Cl
    {
        ...
        [DllImport(Library)]
        private static extern ErrorCode clGetPlatformIDs(UInt32 numEntries,
                                                         [Out] [MarshalAs(UnmanagedType.LPArray)] Platform[] platforms,
                                                         out UInt32 numPlatforms);

        public static ErrorCode GetPlatformIDs(UInt32 numEntries,
                                               Platform[] platforms,
                                               out UInt32 numPlatforms)
        {
        ...
        [DllImport(Library)]
        private static extern ErrorCode clSetKernelArg(IntPtr kernel, uint argIndex, int argSize, IntPtr argValue);

        public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, int argSize, object argValue)
        {
            if (argValue == null)
            {
                //это может быть, если делается __local mem
                return
                    clSetKernelArg((kernel as IHandle).Handle, argIndex, argSize, new IntPtr(0));
            }
            else
            {
                ...
                {
                    return
                        clSetKernelArg((kernel as IHandle).Handle, argIndex, argSize, argPtr);
                }
            }
        }
        ...
        [DllImport(Library)]
        private static extern unsafe ErrorCode clEnqueueReadBuffer(IntPtr commandQueue,
                                                                   IntPtr buffer,
                                                                   Bool blockingRead,
                                                                   IntPtr offset,
                                                                   IntPtr cb,
        ...
        public static unsafe ErrorCode EnqueueReadBuffer(CommandQueue commandQueue,
                                                         Mem buffer,
                                                         Bool blockingRead,
                                                         IntPtr offset,
                                                         IntPtr cb,
        ...
        [DllImport(Library)]
        private static extern unsafe ErrorCode clEnqueueWriteBuffer(IntPtr commandQueue,
                                                                    IntPtr buffer,
                                                                    Bool blockingWrite,
                                                                    IntPtr offset,
                                                                    IntPtr cb,
        ...
        public static unsafe ErrorCode EnqueueWriteBuffer(CommandQueue commandQueue,
                                                          Mem buffer,
                                                          Bool blockingWrite,
                                                          IntPtr offset,
                                                          IntPtr cb,
        ...
        [DllImport(Library)]
        private static extern unsafe ErrorCode clEnqueueNDRangeKernel(IntPtr commandQueue,
                                                                      IntPtr kernel,
                                                                      uint workDim,
        ...
        public static unsafe ErrorCode EnqueueNDRangeKernel(CommandQueue commandQueue,
                                                            Kernel kernel,
                                                            uint workDim,
